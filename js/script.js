function check() {
  ...
  let name = localStorage['current_user'].toUpperCase();
  if (name !== undefined){
    source.value = name.toUpperCase();
  }
...
function saveRedirect()
{
  ...
  if (username) {
    localStorage['current_user'] = document.getElementById("username").value.toUpperCase();
